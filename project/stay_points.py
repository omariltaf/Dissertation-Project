...
# Calculates time span between two points
...
# Calculates mean latitude and longitude using all points passed in
...
# Detects all stay points as proposed by Li et al. (2008)
